...
const CONTROLLER_NAME = 'recurringexpense/';

@Injectable()
export class RecurringExpenseService extends BehaviorSubject<any[]> {
    ...
    public getAllRecurringExpenses() {
        return this.fetch();
    }

    public getRecurringExpense(id: number) {
